...
/*   Updated: 2019/01/24 09:39:30 by gperez           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		check_dimx_dimy(t_cam *cam, char *l1, char *l2)
{
	...
	{
		cam->data.dimx = ft_atoi(l2) <= 100 ? 100 : ft_atoi(l2);
		cam->data.dimx = cam->data.dimx > 7680 ? 7680 : cam->data.dimx;
	}
	else if (!(ft_strcmp(l1, "dimy")))
	{
		cam->data.dimy = ft_atoi(l2) <= 100 ? 100 : ft_atoi(l2);
		cam->data.dimy = cam->data.dimy > 4320 ? 4320 : cam->data.dimy;
	}
